...
// unpacking function
void unpacked(uint packed_data){
    // a, b, c, d, e, f, g = x, y, z, voxel_id, face_id, ao_id, is_transparency;
    ...
    is_transparency = int(packed_data & g_mask);
}
